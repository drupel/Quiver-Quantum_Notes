...
\chapter{Hall Algebras}
  ...
  \section{Basic Definitions}
    ...
    \begin{lemma}
        Let $X$ and $Y$ be noncommuting variables with $YX=t^2XY$ for a formal variable $t$. Then \[(X+Y)^n=\sum_{k=0}^n t^{-k(n-k)}\begin{bmatrix}n\\ k\end{bmatrix}_{t^2} X^kY^{n-k}.\]  
    \end{lemma}
