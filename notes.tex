        ...
        \begin{example}
            We saw last time that the two subspace quiver $1\to 3 \leftarrow 2$ has six isomorphism classes of indecomposables:
                \begin{align*}
                    ...
                    P_1 &= \mathbb{F} \overset{\id}{\to} \mathbb{F} \leftarrow 0 \\
                    P_2 &= 0 \to \mathbb{F} \overset{\id}{\leftarrow} \mathbb{F} \\
                    I_3 &= \mathbb{F} \overset{\id}{\to} \mathbb{F} \overset{\id}{\leftarrow} \mathbb{F}
                \end{align*}
